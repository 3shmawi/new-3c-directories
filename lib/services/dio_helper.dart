  ...
  get(
    ...
    try {
      ...
      if (e is DioException) {
        ...
        AppToast.showError(e.response!.data["message"]!);
      }
      rethrow;
    }
  }
...
void onError(ErrorEntity eInfo) {
  ...
  switch (eInfo.code) {
    case 400:
      if (kDebugMode) {
        AppToast.showError("Bad Request");
      }
      break;
    case 401:
      if (kDebugMode) {
        AppToast.showError("Unauthorized");
      }
      break;
    case 403:
      if (kDebugMode) {
        AppToast.showError("Forbidden");
      }
      break;
    case 404:
      if (kDebugMode) {
        AppToast.showError("Not Found");
      }
      break;
    case 405:
      if (kDebugMode) {
        AppToast.showError("Method Not Allowed");
      }
      break;
    case 408:
      if (kDebugMode) {
        AppToast.showError("Request Timeout");
      }
      break;
    case 409:
      if (kDebugMode) {
        AppToast.showError("Conflict");
      }
      break;
    case 410:
      if (kDebugMode) {
        AppToast.showError("Gone");
      }
      break;
    case 500:
      if (kDebugMode) {
        AppToast.showError("Internal Server Error");
      }
      break;
    case 501:
      if (kDebugMode) {
        AppToast.showError("Not Implemented");
      }
      break;
    case 502:
      if (kDebugMode) {
        AppToast.showError("Bad Gateway");
      }
      break;
    case 503:
      if (kDebugMode) {
        AppToast.showError("Service Unavailable");
      }
      break;
    case 504:
      if (kDebugMode) {
        AppToast.showError("Gateway Timeout");
      }
      break;
    case 505:
      if (kDebugMode) {
        AppToast.showError("HTTP Version Not Supported");
      }
      break;
    default:
      if (kDebugMode) {
        AppToast.showError("Unknown Error");
      }
      break;
  }
}
